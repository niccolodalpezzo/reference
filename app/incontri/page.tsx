...
export default function IncontriPage() {
  const [messages, setMessages] = useState<ChatMsg[]>([{
    role: 'assistant',
    content: 'Ciao! Sono il tuo assistente per gli incontri BNI. Dimmi la tua città o CAP e ti mostro il capitolo più vicino con orari e indirizzo.',
    chapter: null,
  }]);
  ...
  const QUICK_SEARCHES = [
    { text: 'Trova incontro a Milano', icon: '🏙️' },
    { text: 'Capitolo più vicino a Roma', icon: '🏛️' },
    { text: 'Incontri BNI a Torino', icon: '🚗' },
      ...
      <div className="w-full md:w-[420px] flex flex-col bg-white border-l border-ndp-border shrink-0">
        ...
        <div className="bg-ndp-blue px-5 py-4 shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-display font-bold text-white text-sm">Trova incontro BNI</h1>
